...
void StatisticsPage::updateStatistics()
{
	...
	int64_t marketcap = HWWmarket.toDouble();
    ...
    {
        subsidy = "3 HWW per block";
    }
	else if (pindexBest->nHeight < 2000000)
    {
        subsidy = "4 HWW per block";
    }
	else if (pindexBest->nHeight < 3000000)
    {
        subsidy = "3 HWW per block";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " HWW" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " HWW" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " HWW" + "</font></b>");
    }
