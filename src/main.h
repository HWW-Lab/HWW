...
#define BLOCK_START_MASTERNODE_DELAYPAY 1350000 //Activates a delay in payment for MNs - H W W Block 1.35 Million
...
static const int64_t FORTUNA_COLLATERAL = (5000*COIN); // 5,000 HWW
static const int64_t FORTUNA_FEE = (0.010000*COIN); //0.01 HWW
static const int64_t POOL_FEE_AMOUNT = (0.1*COIN); //0.1 HWW
static const int64_t FORTUNA_POOL_MAX = (11000*COIN); //11,000 HWW
...
static const int64_t MAX_MONEY = 10000000 * COIN; // 10,000,000 HWW HWW Max
static const int64_t COIN_YEAR_REWARD = 0.06 * COIN; // 6% per year

static const int64_t MAINNET_POSFIX = 1000; //Mainnet Proof of Stake update not enabled until block 640k
...
static const uint256 hashGenesisBlock("0x00000835e91dcc41045f447fa096a1499efc7b9fc14b434a8c04928b723c7b6f");
