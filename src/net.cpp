...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HWW " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"seed.HWW.host", "seed.HWW.host"},
    {"seed.HWWexplorer.org", "seed.HWWexplorer.org"},
    {"seed.yiimp.eu", "seed.yiimp.eu"},
    {"chainz.cryptoid.info", "chainz.cryptoid.info"},
    {"seed1.HWW.io", "seed1.HWW.io"},
    {"seed2.HWW.io", "seed2.HWW.io"},
    {"seed3.HWW.io", "seed3.HWW.io"},
    {"seed4.HWW.io", "seed4.HWW.io"}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HWW is probably already running."), addrBind.ToString().c_str());
        else
